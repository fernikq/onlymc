...
public class PandoraCommand extends CustomCommand {

    private final CorePlugin plugin;

    public PandoraCommand(String name, String[] aliases, UserGroup group, CorePlugin plugin){
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if(args.length < 2){
            return ChatUtil.sendMessage(sender, MessagesManager.usage("/pandora <gracz> <ilosc>"));
        }
