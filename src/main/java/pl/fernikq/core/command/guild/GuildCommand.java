...
public class GuildCommand extends CustomCommand {
    ...
    public GuildCommand(String name, String[] aliases, UserGroup group, CorePlugin plugin){
        ...
        this.customCommands.add(new GuildInfoCommand("info", new String[0], UserGroup.PLAYER, this.plugin));
        this.customCommands.add(new GuildFightCommand("walka", new String[0], UserGroup.PLAYER, this.plugin));
    }
