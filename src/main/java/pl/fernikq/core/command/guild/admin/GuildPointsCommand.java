...
public class GuildPointsCommand extends CustomCommand {

    private final CorePlugin plugin;

    public GuildPointsCommand(String name, String[] aliases, UserGroup group, CorePlugin plugin){
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if(args.length < 3){
            return ChatUtil.sendMessage(sender, MessagesManager.usage("/ga points <nick> <ilosc>"));
        }
        String nick = args[1];
