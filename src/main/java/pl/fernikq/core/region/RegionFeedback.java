...
public enum RegionFeedback {
    ...
    DENY_DESTROY_GUILD_CENTER(false, "&8>> &fNie mozna niszczyc w centrum gildii!"),
    DENY_BUCKETS_GUILD(false, "&8>> &fNie mozesz uzywac wiaderek na terenie wrogiej gildii!"),
    DENY_BUCKETS_GUILD_CENTER(false, "&8>> &fNie mozesz uzywac wiaderek w centrum gildii!"),
    DENY_SPAWN_VEHICLES_GUILD(false, "&8>> &fNie mozesz spawnowac pojazdow na terenie wrogiej gildii!"),
    DENY_SPAWN_VEHICLES_GUILD_CENTER(false, "&8>> &fNie mozesz spawnowac pojazdow w centrum gildii!"),
