...
public enum RegionFeedback {
    ...
    DENY_PROCCESS_COMMAND_CAUSE_CHECK(false,  MessagesManager.error("Podana komenda nie jest dostepna podczas sprawdzania!")),
    ...
    DENY_BUILD_GUILD_DRILL(false,  MessagesManager.error("Wiertlo mozna postawic tylko na terenie wlasnej gildii")),
    DENY_BUILD_GUILD_DRILL_OWNER(false,  MessagesManager.error("Wiertlo na terenie gildii moze postawic tylko zalozyciel")),
    ...
    DENY_BUILD_GUILD_DRILL_AREA(false,  MessagesManager.error("Nie mozesz budowac tak blisko wiertla!")),
    ...
    DENY_DESTROY_DRILL_GUILD(false,  MessagesManager.error("Nie mozesz niszczyc blokow tak blisko wiertla!")),
    ...
    DENY_BUCKETS_GUILD_DRILL(false,  MessagesManager.error("Nie mozesz uzywac wiaderek tak blisko wiertla!")),
