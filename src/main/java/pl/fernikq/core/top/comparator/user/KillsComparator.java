...
public class KillsComparator implements Sortable<User> {
    ...
    public KillsComparator(CorePlugin plugin, TopType topType, TopKind topKind){
        this.plugin = plugin;
        ...
        this.userComparator = new Comparator<User>() {
            ...
            public int compare(User o1, User o2) {
                int i = Integer.compare(o2.getUserStat().getKills(), o1.getUserStat().getKills());
                if(i == 0){
                    if(o1.getName() == null){
                        return -1;
                    }
